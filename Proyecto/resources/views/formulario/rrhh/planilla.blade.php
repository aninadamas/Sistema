@extends('layouts.app', ['activePage' => 'Supervisor', 'titlePage' => __('Nuevas Solicitudes')])
                ...
                <div class="col-md-10">
                        ...
                        <div class="card ">
                            <div class="card-header card-header-success">
                                <h4 class="card-title">{{ __('Nuevas Solicitud de Permisos ' ) }}</h4>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2 top-left  ">
                                            <a href="{{route('rrhh.aprobar',$p->id)}}" class="btn btn-success" role="button" aria-disabled="true">Aprobar</a>
                                        </div>
                                        <div class="col-sm-2 top-left  ">
                                            <a href="{{route('rrhh.rechazar',$p->id)}}" class="btn btn-danger" role="button" aria-disabled="true">Rechazar</a>
                                        </div>
                                        <div class="col-sm-10 top-left  ">
                                            <a href="{{route('rrhh')}}" class="btn btn-info" role="button" aria-disabled="true">Cancelar</a>
                                        </div>
                            </div>
