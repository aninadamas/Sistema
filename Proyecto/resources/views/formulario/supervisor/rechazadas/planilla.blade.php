                ...
                <div class="col-md-10">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 top-right  py-2 ">
                                        <a href="{{route('supervisor.apruebarechazado',$p->id)}}" class="btn btn-success" role="button" aria-disabled="true">Aprobar</a>
                                </div>
                                ...
                                <div class="col-sm-6 top-left  py-2">
                                    <a href="{{route('supervisor.permiso_rechazado')}}" class="btn btn-info" role="button" aria-disabled="true">Cancelar</a>
                                </div>
                            </div>
                            </div>
