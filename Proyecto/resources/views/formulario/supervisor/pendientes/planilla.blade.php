@extends('layouts.app', ['activePage' => 'Supervisor', 'titlePage' => __('Solicitud Pendiente')])
                ...
                <div class="col-md-10">
                        ...
                        <div class="card ">
                            <div class="card-header card-header-success">
                                <h4 class="card-title">{{ __('Solicitud de permiso en estado: Pendiente ' ) }}</h4>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="col-sm-2 top-right  py-2 ">
                                        <a href="{{route('supervisor.aprobarpendiente',$p->id)}}" class="btn btn-success" role="button" aria-disabled="true">Aprobar</a>
                                </div>



                                <div class="col-sm-2 top-left  py-2">
                                    <a href="{{route('supervisor.rechazarpendiente',$p->id)}}" class="btn btn-danger" role="button" aria-disabled="true">Rechazar</a>
                                </div>
                                <div class="col-sm-9 top-left  py-2">
                                    <a href="{{route('supervisor.pendiente')}}" class="btn btn-info" role="button" aria-disabled="true">Cancelar</a>
                                </div>
                            </div>
                            </div>
